<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('ext_uid')); ?>:</b>
	<?php echo CHtml::encode($data->ext_uid); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('ext_token')); ?>:</b>
	<?php echo CHtml::encode($data->ext_token); ?>
	<br />
